...
df6=pd.merge(df1,df2,left_index=True,right_on='name')
...
```{code-cell} ipython3
m4=pd.merge(m1,m2,left_on=['nom','prenom'],right_on=['last_name','first_name'])
m4=m4.drop('last_name',axis=1)
m4=m4.drop('first_name',axis=1)
m4
```

```{code-cell} ipython3
m5=pd.concat([m4,m3],ignore_index=True)
m5.loc[3,'prenom']=m5.loc[3,'first']
m5.loc[4,'prenom']=m5.loc[4,'first']
m5.loc[3,'nom']=m5.loc[3,'last']
m5.loc[4,'nom']=m5.loc[4,'last']
m5=m5.drop('first',axis=1)
m5=m5.drop('last',axis=1)
m5
```
