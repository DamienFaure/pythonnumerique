...
# %%
newdf.info() #colonne size entièrement vide
...
# %%
print(df.tail(1)) #manque toutes les valeurs
...
# %%
newdf.dtypes # les masses sont des objets et non pas des flottants
...
# %%
newdf['Mass (lb) orig']=newdf['Mass (lb)']
newdf['Mass (lb)']=pd.to_numeric(newdf['Mass (lb)'],errors='coerce')
newdf['Mass (lb)']
